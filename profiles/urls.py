...
urlpatterns = [
    ...
    path('addresses/api/', views.addresses_api_list_view, name='addresses_api_list'),
    path('addresses/api/save/', views.address_save_view, name='address_save'),
    path('addresses/api/delete/<int:address_id>/', views.address_delete_view, name='address_delete'),
