...
urlpatterns = [
    ...
    path('products/detail/<int:product_id>/', views.admin_product_detail_view, name='admin_product_detail'),
    path('products/toggle/<int:product_id>/', views.admin_product_toggle_view, name='admin_product_toggle'),
